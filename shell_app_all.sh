...
while true; do
    select input in env_check_linux mysql_8_linux redis_5_linux mongodb_4_linux elasticsearch_7_linux python_3_linux docker_19_install nacos_latest_docker_compose minio_latest_docker_compose k8s-install quit; do
        case $input in
            env_check_linux)
